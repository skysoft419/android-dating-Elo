...
public class ReportUserActivity extends AppCompatActivity implements AdapterCallback,ServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headerTextView.setText("Report User");
        ...
        deleteButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                commonMethods.showProgressDialog(ReportUserActivity.this,customDialog);
                deleteAccount();
            }
        });
        setAdapter();
    ...
    private void deleteAccount(){
        apiService.reportUser(sessionManager.getToken(),StaticData.report.get(index).getReasonId(),reporterId).enqueue(new RequestCallback(1,this));
    }
    private void setAdapter(){
        layoutManager=new LinearLayoutManager(this);
        adapter=new ActionAdapter(this, StaticData.report,this);
